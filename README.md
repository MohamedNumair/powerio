...
| CGMES (IEC 61970-600) | yes | no (writer is roadmap) | multi-file set, no text echo | 2.4.15 + 3.0, EQ/TP/SSH/SV bus-branch import; assumptions and unmapped classes reported |
