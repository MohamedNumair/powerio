...
- **CGMES** (IEC 61970-600) file sets are read only: both 2.4.15 (CIM16) and
  ...
  are reported, not silently dropped. See the [CGMES chapter](cgmes.md) for
  the version map and roadmap (writer, boundary assembly, distribution CIM).
